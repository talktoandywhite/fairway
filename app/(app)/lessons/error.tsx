...
/**
 * Error boundary for the Lesson Log (list, new, detail, edit — it covers the
 * whole `lessons` segment tree). A failed read or write shows a recoverable
  ...
  return (
    <section className="mx-auto flex max-w-lg flex-col gap-4" role="alert">
      ...
      <p className="text-sm text-muted-foreground">
        Something went wrong reaching your lesson log. Please try again in a
        moment.
      </p>
